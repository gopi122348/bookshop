"""Unit tests for the Book model and CRUD views."""
...
class BookModelTest(TestCase):
    ...
    def setUp(self):
        """Create a sample book for each test."""
...
class BookViewTest(TestCase):
    """Integration tests for book CRUD views."""

    def setUp(self):
        """Set up test client, staff user, and sample book."""
        self.client = Client()
    ...
    def test_book_detail_returns_200(self):
        """Book detail page loads for a valid book pk."""
    ...
    def test_book_delete(self):
        """POST to book_delete removes the book and redirects."""
        self.client.login(username='admin', password=TEST_PASSWORD)
